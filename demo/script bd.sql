...
BEGIN
    ...
    BEGIN TRY
        ...
        ELSE
        BEGIN
            SET @tipo_id = (SELECT tipo_incidente_id FROM tipo_incidente WHERE nombre = @nombre_barrio);
        END
        ...
        ELSE
        BEGIN
            SET @subtipo_id = (SELECT subtipo_incidente_id FROM subtipo_incidente WHERE nombre = @nombre_barrio AND tipo_id = @tipo_id);
        END
